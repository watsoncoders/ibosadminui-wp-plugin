...
},beforePageText:"",afterPageText:"מתוך {pages} מוצג עמוד",displayMsg:"מציג {from} עד {to} מתוך {total} שורות"};
})(jQuery);
(function($){
function _93(_94){
var _95=$(_94);
...
if(pos){
opts.left=pos.left-$(_335).outerWidth();
opts.top=pos.top;
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"טוען, אנא המתן ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_5e5,_5e6){
