<?php
//mail("amir@interuse.co.il", "config.php", var_export($_FILES, true)."|".var_export($_GET, true)."|".var_export($_POST, true)."|".var_export($_SERVER, true));
session_start();
...
if (strpos($_SERVER['SCRIPT_FILENAME'], "uploader/index.php") !== false) // Java uploader
...
$current_path = "../uploads/$userId/"; // relative path from filemanager folder to upload folder (with final /)
...
*******************/
$aviary_active=true;
$aviary_key="9b73a31762e41f9f";
$aviary_secret="b98f53f242196995";
$aviary_version=3;
$aviary_language='en';
