...
mmSWFUpload = {
	...
	init: function(settings) {
		...
		// Create SWFObject
		var so = new SWFObject("jscripts/SWFUpload/upload.swf", "_mmSWFUploadField", this.addSetting("width", "76px"), this.addSetting("height", "21px"), this.addSetting("flash_version", "8"), "#000000");
		...
		if(this.settings["debug"] == true) {
			...
			document.write("<strong>Width:</strong> " + this.settings["width"] + "<br />");
			document.write("<strong>Height:</strong> " + this.settings["height"] + "<br />");
			document.write("<strong>Button image:</strong> " + this.settings["button_image"] + "<br />");
